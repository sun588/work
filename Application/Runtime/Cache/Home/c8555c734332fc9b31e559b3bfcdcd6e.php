...
<head>
    ...
    <link href="/Public/Home/dataTable/dataTable.min.css" rel="stylesheet">
						...
						<div class="entry-content">
							<div class="entry-summary">
								<div class="woocommerce">
                                    <table id="evaluateContent" class="display">
                                        <thead>
                                            <tr>
                                                <th>图片</th>
                                                <th>产品</th>
...
<script type="text/javascript" src="/Public/Home/js/themejs/addtocart.js"></script>
    <script type="text/javascript" src="/Public/Home/dataTable/dataTable.min.js"></script>

<script type="text/javascript">

    var dataTableObj = $('#evaluateContent').DataTable({
        language:{
            ...
            paginate:{first:'第一页',last:"最后一页",previous:"上一页",next:"下一页"},
            search: "过滤记录:",
        },
        serverSide:true,
        ajax:{
            url:'<?php echo U("Businessuser/evaluate");?>',
            type:'post',
            dataType:'json',
            data:{},
