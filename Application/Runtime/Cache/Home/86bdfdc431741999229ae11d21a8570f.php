				...
				<div class="product-view row">
					<div class="left-content-product">
						...
						<div class="content-product-right col-md-7 col-sm-12 col-xs-12">
                            ...
                            <form action="<?php echo U('Order/order1');?>" method="post">
                                <span>请选择心仪的价格：</span>
                                <div class="" style="border-top:1px solid #eee;height: 200px;padding: 10px;overflow: auto;">
                                    <div class="inner-box-desc">
                                        <?php if(is_array($offer)): $i = 0; $__LIST__ = $offer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="price-tax">
                                               ...
                                               <div class="baojia4">
                                                    <label class="guige-yanse chosePrice"   isChose="false" onclick="chosePrice('<?php echo ($row["id"]); ?>',this)">
                                                        选择
                                                        <input style="display: none;" type="radio" AUTOCOMPLETE="off" name="oid" value="<?php echo ($row["id"]); ?>">
                                                    </label>
                                               </div>
                                ...
                                <div id="product">
                                    ...
                                    <div class="form-group box-info-product" style="margin-top:20px;">
                                        ...
                                        <div class="cart">
                                            <input onclick="addCart('<?php echo ($product["id"]); ?>')" type="button" data-toggle="tooltip" title="" value="加入购物车" data-loading-text="Loading..." id="button-cart" class="btn btn-mega btn-lg"  data-original-title="加入购物车" style="background-color:#c2c1c0;">
                                        </div>
                                        <div class="cart">
                                            <input type="hidden" value="<?php echo ($product["id"]); ?>" name="pid">
                                            <input onclick="buy(this)" type="button" data-toggle="tooltip" title="" value="立即购买" data-loading-text="Loading..." id="button-buy" class="btn btn-mega btn-lg" data-original-title="立即购买">
                                        </div>
                                    </div>
                                </div>
                            </form>
