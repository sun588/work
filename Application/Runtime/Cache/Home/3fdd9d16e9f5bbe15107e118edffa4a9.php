				...
				<div class="row">
				    <div class="col-md-12 zhuce">
                       <ul style="  margin-left: 23%;margin-bottom: 30px;">
                          ...
                          <a href=""><li style="border-bottom: 4px solid #ff5e00;line-height: 57px;"><span >2</span>填写账号信息</li></a>
                          <a href=""><li><span style="background-color: #999;">2</span>注册成功</li></a>
                       </ul>
				    </div>
				    <div class="col-md-12">
				        <div style="    margin-left: 25%;width: 50%; margin-top: 30px;background-color: #fff;">
				            <form action="#" method="get" id="form-login" accept-charset="utf-8">
                                ...
                                <div class="form-box">
									...
									<input type="text" id="name-login" name="name-login" placeholder="请输入你的昵称" >
								</div><!-- /.form-box -->
								<div class="form-box buzou">
									<a href="reg-3.html" style="color:#fff;" class="login" ><span>提交</span></a>
								</div><!-- /.form-box -->
							</form><!-- /#form-login -->
				        </div>
				    </div>	
