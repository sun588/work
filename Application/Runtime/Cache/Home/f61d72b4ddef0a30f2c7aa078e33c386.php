			...
			<div class="container">
				<div class="row">
				    <div class="col-md-12 zhuce">
                       <ul style="  margin-left: 35%;margin-bottom: 30px;">
                          <a href=""><li style="border-bottom: 4px solid #ff5e00;line-height: 57px;"><span>1</span>注册用户</li></a>
                          <a href=""><li><span style="background-color: #999;">3</span>注册成功</li></a>
                       </ul>
				    </div>
				    <div class="col-md-12">
				        <div style="    margin-left: 25%;width: 50%; margin-top: 30px;background-color: #fff;">
				        	<form action="<?php echo U('register/');?>" method="post" id="form-register" accept-charset="utf-8">
                                <h3>设置登录信息</h3>
								<div class="form-box">
                                ...
                                <div class="form-box">
                                    ...
                                    <input type="text" id="nickname" name="nickname" placeholder="请输入你的昵称" >
                                </div><!-- /.form-box -->
                                <div class="form-box" style="text-align: center; margin-top: 14px;">
                                    <input type="checkbox" id="xieyi" name="xieyi" style="vertical-align: middle;width: 20px;"> <a href=""><span>我已阅读并同意协议</span></a>
                                </div>
								<div class="form-box buzou">
									<a href="javascript:void(0);" class="login" style="color:#fff;" onclick="register()"><span>提交注册</span></a>
								</div><!-- /.form-box -->
							</form><!-- /#form-login -->
				        </div>
				    </div>	
...
function register() {
   ...
   $.post('<?php echo U("register");?>',$('#form-register').serialize(),function(rs){
        if(rs){
            rs = JSON.parse(rs);
            if(rs['errno'] == 1){
                location.href = '<?php echo U(success);?>';
            }else {
                alert(rs['msg']);
            }
        }else {
